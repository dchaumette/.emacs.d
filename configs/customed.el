...
(custom-set-variables
 ...
 '(erc-away-nickname "dami0u_away")
 '(erc-email-userid "damien.chaumette@gmail.com")
 ...
 '(erc-user-full-name "Damien chaumette")
...
; '(ldap-host-parameters-alist (quote (("localhost" base "dc=squiz,dc=net" binddn "cn=Readonly,dc=squiz,dc=net" passwd "foo_bar_chmouel" auth simple))))
 ...
 '(user-full-name "Damien chaumette")
 '(user-mail-address "damien.chaumette@gmail.com")
...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(cperl-array-face ((((class color) (background dark)) (:foreground "yellow3" :weight bold))))
 '(cperl-hash-face ((((class color) (background dark)) (:foreground "orange2" :slant italic :weight bold))))
